...
class EntityCollectionForm extends EntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label collection. The collection has been queued for sending during the next cron run.', [
          '%label' => $chatbot_api_entities_collection->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label collection. The collection has been queued for sending during the next cron run.', [
          '%label' => $chatbot_api_entities_collection->label(),
        ]));
    }
